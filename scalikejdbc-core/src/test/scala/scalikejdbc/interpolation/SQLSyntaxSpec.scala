...
class SQLSyntaxSpec extends FlatSpec with Matchers {
  ...
  it should "have #append" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(123))
  }
  ...
  it should "have #join for delimiter with parameters" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(1, "Alice", "Bob", 2, "Alice", "Bob", 3))
  }
  ...
  it should "have #csv" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(123, "Alice"))
  }
  ...
  it should "have #gt" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(200))
  }
  ...
  it should "have #in for 3 columns" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(1, "Alice", 20, 2, "Bob", 23))
  }
  ...
  it should "have #in for 4 columns" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(1, "Alice", 20, "bar", 2, "Bob", 23, "baz"))
  }
  ...
  it should "have #in for 5 columns" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(1, "Alice", 20, "bar", null, 2, "Bob", 23, "baz", time))
  }
  ...
  it should "have #in with subQuery" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(false))
  }
  ...
  it should "have #like" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq("%abc%"))
  }
  ...
  it should "have #roundBracket" in {
    ...
    s.parameters.map(parameterExtractor) should equal(Seq(123, "Alice", 12))

    val s2 = SQLSyntax.roundBracket(SQLSyntax.eq(sqls"name", "Foo"))
    s2.value should equal("( name = ?)")
    s2.parameters.map(parameterExtractor) should equal(Seq("Foo"))
  }
  ...
  it should "have joinWithAnd" in {
    ...
    s1.parameters.map(parameterExtractor) should equal(Seq(123))
    ...
    s2.parameters.map(parameterExtractor) should equal(Seq(123, 234, 345))
  }
